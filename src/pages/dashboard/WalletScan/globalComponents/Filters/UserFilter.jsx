...
import emailIcon from "../../assets/images/icons/home_logo_3.svg";
import axios from "axios";

import defaultImage from "../../assets/images/icons/app_placeholder.png";
  ...
  useEffect(() => {
    ...
    switch (tabSelected) {
      case "Earnings Per Customers":
        axios
          .get(
            `https://comms.globalxchange.com/coin/iced/banker/earned/spread/per/customer/get?banker_email=${bankerEmail}`
          )
          .then((res) => {
      ...
      default:
        axios
          .get(
            `https://comms.globalxchange.com/coin/iced/banker/custom/bond/users/data/get?email=${bankerEmail}`
          )
          .then((res) => {
            setAllBondHolders(res.data.users);
          });
