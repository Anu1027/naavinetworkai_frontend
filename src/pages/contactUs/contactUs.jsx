                            ...
                            <div className="contact">
                                ...
                                <div className="item ps-2">
                                    <div className="d-flex">
                                        <FontAwesomeIcon icon={faUser} style={iconStyle} /> <p>Aditya AS</p>
                                    </div>
                                    <hr />
                                    <div className="email1 d-flex">
                                        <FontAwesomeIcon icon={faEnvelope} style={iconStyle} />  <p>mail@naavi.network</p>
                                    ...
                                    <div className="socialIcon text-center">
                                        ...
                                        <a href="https://www.linkedin.com/in/aditya-as-83a301278/" target='_blank'>
