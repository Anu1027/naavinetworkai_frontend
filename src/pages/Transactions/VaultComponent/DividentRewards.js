...
const DividentRewards = ({
  ...
  //   passTypeTransaction,
    ...
    const { Divident } = useAppContextDetails();
//   const { coinType, Divident } = useCoinContextData();
  const alldirection = [
    { name: Divident?.coinSymbol, field: Divident?.coinSymbol },
    // { name: 'Deposit', field: 'deposit' },
    // { name: 'Withdrawals', field: 'withdraw' },
  ];
  const alltypes = [
    { name: 'Exchange fees', field: 'Exchange fees' },
...
export default DividentRewards;
