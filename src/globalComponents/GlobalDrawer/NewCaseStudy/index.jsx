...
const NewCaseStudy = ({ step, setStep, setMainMenu, loading, setLoading }) => {
  ...
  const getContent = () => {
   ...
   <img src = {arrowDown} width = "30px" alt = "down"/>
                ...
                {/*Case Study */}
                <div className="name">Case Study</div>
                <div className="inputWrap">
                  <input
                    value={caseStudy}
  ...
  const AddNewCaseStudy = () => {
    setLoading(true);
    axios
      .post(`https://publications.apimachine.com/casestudy/new`, {
